...
title(['^{Cl}/_{Cd} vs \alpha for ' section]);
xlabel("\alpha");
ylabel('^{Cl}/_{Cd}');
grid on;
hold on;
...
figure(1);
plot(alpha,clswp);
legend(num2str(Re1,'%.2g'),num2str(Re2,'%.2g'),'Location','Best');
